               ...
               <div class="card card-primary">
                  <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <li><span>CODE OPTIMIZATION AND BUG FIXS</span></li>
                        <h2>VERSION 2.3</h2>
                        <li><span>4 NEW PAGES, 2 REQUEST, 1 CONTROLLER</span></li>
                        <li><span>RE-WRITE ALL THE ROUTES</span></li>
                        <li><span>DO ALL (CRED) OPREATION FOR (CERTIFICATE)</span></li>
                        <li><span>FINISHED ALL ADMINSTRATION (CRUD) OPREATIONS</span></li>
                        <li><span>FIXED A BUG IN UPDATE FOR CLIENT</span></li>
                        <li><span>MAKE SURE NOT TO DELETE THE LOGGED IN USER</span></li>
                        <li><span>ADD MORE CUSTOM REQUESTS TO ALL FORMS IN ADMINSTRATION</span></li>
                        <li><span>FIRST-DESIGN FOR V3 FOR DATABASE</span></li>
                        <li><span>PROJECT FILES MANGMENT TO V3</span></li>
                        <li><span>CODE OPTIMIZATION AND BUG FIXS</span></li>
                    </div>
               </div>
            </div>
