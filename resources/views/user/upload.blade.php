                  ...
                  <div class="col-12 col-md-12 col-lg-6 order-2 order-md-2">
                        <div class="row">
                           <div class="col-12">
                              ...
                              <div class="card card-primary">
                                 <div class="card-header">
                                    <h3 class="card-title">Older Certificate files</h3>
                                 </div>
                                 <div class="card-body">
                                    @if ($year !=null && $expiredFiles != null)
                                       @foreach ($year as $record)
                                          <h3>{{$record}}</h3>
                                          @foreach ($expiredFiles as $files)
                                          <a href="{{ asset('files') . '/' . $files->path }}">{{ $files->path }}</a>
                                          @endforeach
                                       @endforeach
                                    @else
                                       <h3>Nothing Found</h3>
