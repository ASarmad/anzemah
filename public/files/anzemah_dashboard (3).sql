...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2023 at 06:20 PM
...
(3, 3, 1, 'Scoping', 'Provide a list of office locations, cloud environments, and data centers that store, process or transmit information covered under this assessment.', 'Not Uploaded', NULL, '2023-10-20 17:38:55'),
...
CREATE TABLE `uploads` (
  `id` bigint UNSIGNED NOT NULL,
  `evidance_id` int UNSIGNED DEFAULT NULL,
